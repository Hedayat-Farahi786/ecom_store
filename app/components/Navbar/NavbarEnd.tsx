  ...
  return (
    <>
      <div className="navbar-end space-x-2">
        <div className="flex items-center space-x-2">
          <div className="dropdown dropdown-end flex items-center space-x-2">
            <div
              className="cursor-pointer flex flex-row-reverse md:flex-row items-center justify-center"
            >
              {/* <svg
              ...
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="size-5 hidden md:flex ml-5"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
      ...
      {/* <div className="navbar-end">
          <button onClick={() => dispatch(authenticate())} className="btn">
            Sign In
          </button>
        </div> */}
    </>
